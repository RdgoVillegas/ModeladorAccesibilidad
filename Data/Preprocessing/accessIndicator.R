...
# Etapa I:  Cargar archivos
require(tidyverse); require(sf)
# Cargar tabla de origen-destino
load(file = "mzn_rbd.RDS")
# Cargar escuelas
load(file = "processed files/rbd_procesadas.RDS")
# Cargar manzanas
load(file = "processed files/mzns_procesadas.RDS")
